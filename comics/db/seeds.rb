...
books = Book.create(
  [
    ...
    {title: "The Walking Dead 149", issue: 149, writer: "Robert Kirkman", artist: "Charlie Adlard", cover: "twd149.jgp", releaseDate: "11/25/15", publisher_id: 3},
    {title: "Invincible 126", issue: 126, writer: "Robert Kirkman", artist: "Ryan Ottley", cover: "inv126.jgp", releaseDate: "11/25/15", publisher_id: 3},
    {title: "Saga 31", issue: 31, writer: "Brian K. Vaughan", artist: "Fiona Staples", cover: "saga31.jgp", releaseDate: "11/25/15", publisher_id: 3}
  ]
)

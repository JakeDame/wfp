...
books = Book.create(
  [
    ...
    {title: "Amazing Spider-man 4", issue: 4, writer: "Dan Slott", artist: "Guiseppe Camuncoli", cover: "asm4.png", releaseDate: "11/25/15", publisher_id: 1},
    {title: "Deadpool 3", issue: 3, writer: "Gerry Duggan", artist: "Mike Hawthorne", cover: "dp3.png", releaseDate: "11/25/15", publisher_id: 1},
